...
<section class="bg-[#f9f9f7] py-24 px-6">
  <div class="max-w-[1200px] mx-auto text-center">
    <h2 class="text-[40px] font-light text-gray-900 mb-16">
      Endless finishes. <span class="text-gray-400">Infinite possibilities.</span>
    </h2>

    <div class="mb-8">
      <h3 class="text-2xl font-normal mb-2">Fitted wardrobes</h3>
      <p class="text-gray-500 text-sm">Tailored to your space, designed for your life.</p>
    </div>
    ...
    <div class="relative w-full h-[400px] bg-white rounded-xl mb-8 flex items-center justify-center overflow-hidden shadow-sm">
      ...
      <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=2070&auto=format&fit=crop" class="h-[80%] object-contain" alt="Wardrobe design" />
    </div>

    <!-- Controls -->
    <div class="flex justify-center gap-4 mb-8">
      <button class="w-8 h-8 rounded-full bg-white border-2 border-primary-500 ring-2 ring-offset-2 ring-primary-200"></button>
      <button class="w-8 h-8 rounded-full bg-[#8B7355]"></button>
      <button class="w-8 h-8 rounded-full bg-[#374151]"></button>
      <button class="w-8 h-8 rounded-full bg-[#D4AF37]"></button>
    </div>
    ...
    <p class="text-xs text-gray-500 mb-8">
      Free consultation and CAD visualization included.<br>
      Typical installation: 1-3 days depending on complexity.
    </p>
    ...
    <div class="flex justify-center gap-4">
      <button class="px-6 py-3 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm font-medium transition-colors text-left">
        ...
        <span class="text-primary-600">View our portfolio</span>
      </button>
